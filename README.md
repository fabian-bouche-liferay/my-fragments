# My Sample Liferay Fragments

The fragments inclded in this library rely on a project that allows for the
loading of third party JS libraries from a CDN:

https://github.com/fabian-bouche-liferay/my-js-loader
